...
ALLOWED_HOSTS = ['dannynak2.pythonanywhere.com']
...
# JWT settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=365),  # Adjust token lifetime as needed
    'REFRESH_TOKEN_LIFETIME': timedelta(days=365),  # Adjust refresh token lifetime
